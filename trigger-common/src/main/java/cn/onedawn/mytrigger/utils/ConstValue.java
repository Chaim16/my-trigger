...
public class ConstValue {
    ...
    public static final String SERVER = "mytrigger-center";
    public static final String SERVER_PORT = "8080";
    public static final String BASE_URL = "http://" + ConstValue.SERVER + ":" + ConstValue.SERVER_PORT;

    public static final String NAMESERVADDR = "http://rocketmq-namesrv:9876";

    public static final String ZOOKEEPER_ADDRESS = "zookeeper:2181";
